...
export default()=>{
  return (
   ...
   <Layout>
    ...
    description='Apptrack is a job application tracker built with React, Redux, and Ruby on Rails. This application allows a user to upload PDF resumes, log job applications, and organize the applications with folders. /n Live demo only logs applications --  See video demo for full features.'/>
